    ...
    override fun onClick(v: View?) {
        when (v!!.id) {
            ...
            R.id.tv_add_image -> {
                ...
                pictureDialog.setTitle("Action")
                val pictureDialogItems =
                        arrayOf("Choisissez une photo", "Prendre une photo")
            ...
            R.id.btn_save -> {
                ...
                when {
                    et_title.text.isNullOrEmpty() -> {
                        Toast.makeText(this, "Ajouter un titre", Toast.LENGTH_SHORT).show()
                    }
                    et_description.text.isNullOrEmpty() -> {
                        Toast.makeText(this, "Ajouter une description", Toast.LENGTH_SHORT)
                                .show()
                    }
                    et_location.text.isNullOrEmpty() -> {
                        Toast.makeText(this, "Choisissez un lieu", Toast.LENGTH_SHORT)
                                .show()
                    }
